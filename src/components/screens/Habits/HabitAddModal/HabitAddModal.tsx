          ...
          formatGroupLabel={(data: IGroupedOption) => (
            <div>
              {user.level >= data.demandLevel ? (
                ...
                <span>
                  Категория "{data.label}" откроется на {data.demandLevel} уровне
                </span>
              )}
            </div>
          )}
      ...
      {selectedOption?.value === 'self' ? (
        <form role="form" className={styles['habits-modal__form']} onSubmit={handleSubmit(handleAddHabit)} onChange={() => handleChangeForm()}>
          <div className={styles['habits-modal__item']}>
            <label htmlFor="title-input" className={styles['habits-modal__item-title']}>
              Название:
            </label>
          ...
          <div className={styles['habits-modal__item']}>
            <label htmlFor="category-input" className={styles['habits-modal__item-title']}>
              Категория:
            </label>
            <input
              id="category-input"
          ...
          <div className={styles['habits-modal__item']}>
            <label htmlFor="period-select" className={styles['habits-modal__item-title']}>
              Период:
            </label>
          ...
          <div className={styles['habits-modal__item']}>
            <label htmlFor="countable-select" className={styles['habits-modal__item-title']}>
              Цель привычки:
            </label>
        ...
        <PrimaryButton
          ...
          icon={VscDiffAdded}
          className={styles['habits-modal__submit']}
